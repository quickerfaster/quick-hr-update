<x-layout>
    ...
    @php
        ...
        if ($attendance_id) {
            $attendance = \App\Modules\Attendance\Models\Attendance::where('id', $attendance_id)->first();
    ...
    <livewire:qf::data-tables.data-table-manager :selectedItemId="$id ?? null" model="App\Modules\Attendance\Models\AttendanceSession"
