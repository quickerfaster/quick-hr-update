@php
    ...
    $resolver = app(ConfigResolver::class, ['configKey' => "attendance.attendance_policy"]);
...
<x-qf::navigation-layout configKey="attendance.attendance_policy" context="policies" moduleName="attendance" :overrides="[
    ...
    @livewire($customComponent, ["inline" => true, "recordId" => $recordId, "configKey" => "attendance.attendance_policy", "returnParams" => $returnParams])
