...
use App\Modules\Attendance\Models\ShiftSchedule;
...
class Shift extends Model
{
    ...
    {
        return $this->hasMany(\App\Modules\Attendance\Models\ShiftSchedule::class, 'shift_id', 'id');
    }

    public function attendanceRecords()
    {
        return $this->hasMany(\App\Modules\Attendance\Models\Attendance::class, 'shift_id', 'id');
    }

    public function templateSource()
    {
        return $this->belongsTo(\App\Modules\Attendance\Models\Shift::class, 'created_from_template_id', 'id');
    }
    ...
    {
        return \App\Modules\Attendance\Database\Factories\ShiftFactory::new();
    }
}
