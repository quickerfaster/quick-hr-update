...
class WorkflowNotificationTemplateSeeder extends Seeder
{
    /**
     * Seed the notification templates required by the Payroll Run workflow.
     *
     * These templates are consumed by WorkflowEngine::notifyTransition()
     * when the payroll_run workflow definition's "notifications" section
