...
namespace App\Modules\Payroll\Jobs\Payrolls;
...
public function handle(PayrollCalculator $calculator): void
{
    ...
    if ($progress && $progress->processed_employees >= $progress->total_employees) {
        ...
        \App\Modules\Payroll\Jobs\Payrolls\FinalizePayrollRun::dispatch($this->payrollRunId);
    }
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        $run = \App\Modules\Payroll\Models\PayrollRun::find($this->payrollRunId);
        if ($run) {
