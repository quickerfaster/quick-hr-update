...
class PayrollPolicy extends Model
{
    ...
    {
        return $this->belongsTo(\App\Modules\Payroll\Models\PayrollPolicy::class, 'parent_policy_id', 'id');
    }

    public function childPolicies()
    {
        return $this->hasMany(\App\Modules\Payroll\Models\PayrollPolicy::class, 'parent_policy_id', 'id');
    }

    public function assignments()
    {
        return $this->hasMany(\App\Modules\Payroll\Models\PayrollPolicyAssignment::class, 'payroll_policy_id', 'id');
    }
