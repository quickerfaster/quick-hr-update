...
class PayrollRun extends Model implements Workflowable
{
    ...
    {
        return $this->hasMany(\App\Modules\Payroll\Models\PayrollPayslip::class, 'payroll_run_id', 'id');
    }

    public function adjustments()
    {
        return $this->hasMany(\App\Modules\Payroll\Models\PayrollRunAdjustment::class, 'payroll_run_id', 'id');
    }
