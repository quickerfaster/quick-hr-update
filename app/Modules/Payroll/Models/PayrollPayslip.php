...
class PayrollPayslip extends Model
{
    ...
    {
        return $this->belongsTo(\App\Modules\Payroll\Models\PayrollRun::class, 'payroll_run_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Modules\Payroll\Models\PayslipItem::class, 'payslip_id', 'id');
    }
