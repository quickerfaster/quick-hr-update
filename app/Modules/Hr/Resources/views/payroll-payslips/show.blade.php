@php
    ...
    $resolver = app(ConfigResolver::class, ['configKey' => "hr.payroll_payslip"]);
...
<x-qf::navigation-layout configKey="hr.payroll_payslip" context="payroll" moduleName="hr" :overrides="[
    ...
    @livewire($customComponent, ["inline" => true, "recordId" => $recordId, "configKey" => "hr.payroll_payslip", "returnParams" => $returnParams])
