@php
    ...
    $resolver = app(ConfigResolver::class, ['configKey' => "hr.employee_job_history"]);
...
<x-qf::navigation-layout configKey="hr.employee_job_history" context="people" moduleName="hr" :overrides="[
    ...
    @livewire($customComponent, ["inline" => true, "recordId" => $recordId, "configKey" => "hr.employee_job_history", "returnParams" => $returnParams])
