@php
    ...
    $resolver = app(ConfigResolver::class, ['configKey' => "hr.employee_position"]);
...
<x-qf::navigation-layout configKey="hr.employee_position" context="people" moduleName="hr" :overrides="[
    ...
    @livewire($customComponent, ["inline" => true, "recordId" => $recordId, "configKey" => "hr.employee_position", "returnParams" => $returnParams])
