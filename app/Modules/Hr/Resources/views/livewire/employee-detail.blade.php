                ...
                <div class="tab-content">
                    ...
                    @if ($activeTab == 'employment')
                        <div class="row g-4">
                                        ...
                                        @if ($this->canEdit())
                                            ...
                                            @else
                                                <button
                                                    wire:click="$dispatch('openDrawer', {
                                                        component: 'qf.data-table-form',
                                                        params: { configKey: 'hr.employee_position', prefilledData: { employee_id: {{ $employee->id }} }, inline: true },
                                                        title: 'Add Position'
                                                    })"
                                                    class="btn btn-sm btn-outline-primary">
                            ...
                            @if (!$this->isSelfServiceMode || !$this->hideCompensation())
                            <div class="col-12 col-xl-6">
                                <div class="card border-0 shadow-sm h-100">
                                    <div
                                        class="card-header bg-white border-bottom-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                                        ...
                                        @if ($this->canEdit())
                                            ...
                                            @else
                                                <button
                                                    wire:click="$dispatch('openDrawer', {
                                                        component: 'qf.data-table-form',
                                                        params: { configKey: 'payroll.employee_payroll_profile', prefilledData: { employee_id: {{ $employee->id }} }, inline: true },
                            ...
                            <div
                                ...
                                @if ($this->canEdit())
                                    <button
                                        wire:click="$dispatch('openDrawer', {
                                            component: 'qf.data-table-form',
                                            params: { configKey: 'attendance.employee_work_pattern', prefilledData: { employee_id: {{ $employee->id }} }, inline: true },
                                                        ...
                                                        <td>
                                                            @if ($this->canEdit())
                                                                <button
                                                                    wire:click="$dispatch('openDrawer', {
                                                                        component: 'qf.data-table-form',
                                                                        params: { configKey: 'attendance.employee_work_pattern', recordId: {{ $pattern->id }}, inline: true },
